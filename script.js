...
const i18n = {
    de: {
        ...
        's2-eyebrow': 'So funktioniert maiqo',
        's2-h2-line1': 'Einmal eingeben.',
        's2-h2-em': 'Überall compliant.',
        's2-sub': 'Unternehmensdaten werden automatisch auf jeden Standard übersetzt.',
        's2-kicker': 'Deine Daten',
        's2-title': 'Ein zentrales Datenmodell',
        's2-row-policies': 'Richtlinien',
        's2-row-implementations': 'Umsetzungsbeschreibungen',
        's2-row-evidence': 'Nachweise',
        's2-core-label': 'KI-Mapping',
        'more-standards': 'Weitere',
        'hero-cta-primary': 'Gespräch vereinbaren',
        'hero-cta-secondary': 'Mehr erfahren',
        'eu-flag-text': 'Build and Hosted in EU',
        ...
        'enterprise-compliance-title': 'maiqo für Enterprise Compliance',
        'enterprise-compliance-subtitle': 'Speziell entwickelt für Unternehmen mit hoher Compliance-Komplexität',
        'enterprise-card-1-title': 'Organisatorische Komplexität',
        'enterprise-card-1-desc': 'Mehrere Standorte, hunderte Mitarbeitende, komplexe Organisationsstrukturen',
        'enterprise-card-1-item-1': '250+ Mitarbeitende',
        'enterprise-card-1-item-2': 'Multiple Standorte & Tochtergesellschaften',
        'enterprise-card-1-item-3': 'Dezentrale Verantwortlichkeiten',
        'enterprise-card-2-title': 'Regulatorische Anforderungen',
        'enterprise-card-2-desc': 'Verpflichtung zur Einhaltung multipler nationaler und internationaler Standards',
        'enterprise-card-2-item-1': 'NIS2, DORA, EU AI Act, CRA, ...',
        'enterprise-card-2-item-2': 'ISO 27001, ISO 9001, TISAX, ...',
        'enterprise-card-2-item-3': 'Branchenspezifische Vorgaben',
        'enterprise-card-3-title': 'Regulierte Kunden',
        'enterprise-card-3-desc': 'Geschäftsbeziehungen mit Kunden, die strikte Compliance-Nachweise verlangen',
        'enterprise-card-3-item-1': 'Finanzdienstleister & Banken',
        'enterprise-card-3-item-2': 'Behörden & Verteidigung',
        'enterprise-card-3-item-3': 'KRITIS-Unternehmen',
        'enterprise-cta-text': 'Erkennen Sie Ihr Unternehmen wieder?',
        'eu-flag-text': 'Built & Hosted in the EU',
        ...
        'jobs-no-openings': 'Aktuell haben wir keine offenen Stellen, freuen uns aber jederzeit über Initiativbewerbungen an <a href="mailto:hello@maiqo.io">hello@maiqo.io</a>.',
        ...
        'job-3-title': 'AI/ML Engineer',
        'job-3-description': 'Entwickle und optimiere KI-Modelle für Compliance-Automatisierung und Dokumentenanalyse.',
        'job-type-fulltime': 'Vollzeit',
        'job-tag-remote': 'Remote',
        'job-tag-germany': 'Deutschland',
        ...
        'footer-made-in-germany': 'Made in Germany',
        'impressum-page-title': 'Impressum - maiqo.io',
        ...
        'impressum-umsatzsteuer-nummer': 'DE460396778',
        ...
        'job-intro-2': '<strong>Was uns besonders macht:</strong> Datensouveränität. Betrieb in Deutschland, ein konsequent europäischer Ansatz – ideal für sensible Compliance- und Sicherheitsdaten.',
        'job-intro-3': 'Für den weiteren Aufbau suchen wir eine:n erste:n Full-Stack Developer:in, der/die Lust hat, ein SaaS-Produkt von Anfang an technisch mitzugestalten – Architektur, Entwicklung, KI-Features und Betrieb.',
        'job-section-tasks': 'Deine Aufgaben',
        'job-task-1': 'Entwicklung unserer SaaS-Anwendung end-to-end (Frontend, Backend, Datenbank)',
        'job-task-2': 'Mitgestaltung von Architektur, Datenmodell und technischen Standards',
        'job-task-3': 'Umsetzung neuer Features in Next.js / TypeScript inkl. sauberem API-Design',
        'job-task-4': 'Sicherstellung von Qualität und Stabilität (Tests, Reviews, Monitoring, zuverlässige Deployments)',
        'job-task-5': 'Mitverantwortung für Betrieb und DevOps in einem schlanken, automatisierten Setup (CI/CD, Monitoring, Observability)',
        'job-task-6': 'KI-nahe Produktentwicklung: du integrierst und produktisierst LLM-basierte Funktionen (z. B. Analyse, Assistenz, Automatisierung) und denkst Themen wie Qualität, Kosten, Sicherheit und Skalierung mit.',
        'job-section-stack': 'Unser Stack',
        'job-stack-note': 'Early Stage: modern, schnell, pragmatisch – und offen für gute technische Entscheidungen.',
        'job-section-requirements': 'Was du mitbringen solltest',
        'job-requirements-must': 'Must-have',
        'job-req-must-1': 'Sehr gute Kenntnisse in TypeScript / Node.js / Next.js',
        'job-req-must-2': 'Solide Full-Stack- und Architektur-Erfahrung im SaaS-Umfeld',
        'job-req-must-3': 'PostgreSQL & relationale Datenmodelle',
        'job-req-must-4': 'Ownership-Mindset',
        'job-requirements-experience': 'Erfahrung mit',
        'job-req-exp-1': 'Auth-, Rollen- & Rechtesystemen',
        'job-req-exp-2': 'Multi-Tenancy & Audit-Logs',
        'job-req-exp-3': 'CI/CD und produktivem Betrieb',
        'job-requirements-nice': 'Nice-to-have',
        'job-req-nice-1': 'Security-, Compliance- oder Regulatorik-Nähe',
        'job-req-nice-2': 'Erfahrung mit Markteinführungen',
        'job-req-nice-3': 'KI-/LLM-Produktintegration',
        'job-section-benefits': 'Was wir bieten',
        'job-benefit-1': '<strong>100% Homeoffice</strong> (remote-first)',
        'job-benefit-2': '<strong>Startup von Anfang an:</strong> viel Gestaltungsspielraum und direkter Einfluss auf Produkt & Architektur',
        'job-benefit-3': '<strong>Hohe Verantwortung</strong> und kurze Entscheidungswege',
        'job-benefit-4': '<strong>Wachstumschancen:</strong> Erster Entwickler in einem wachsenden Team',
        'job-benefit-5': '<strong>Moderne Dev-Tools</strong> und ein Setup, das auf saubere, skalierbare Entwicklung ausgelegt ist',
    ...
    en: {
        ...
        'metric-uptime': 'Frameworks',
        's2-eyebrow': 'How maiqo works',
        's2-h2-line1': 'Enter once.',
        's2-h2-em': 'Compliant everywhere.',
        's2-sub': 'Your company data is automatically mapped to every relevant standard.',
        's2-kicker': 'Your Data',
        's2-title': 'One Central Data Model',
        's2-row-policies': 'Policies',
        's2-row-implementations': 'Implementations',
        's2-row-evidence': 'Evidence',
        's2-core-label': 'AI Mapping',
        'more-standards': 'More',
        ...
        'enterprise-compliance-title': 'maiqo for Enterprise Compliance',
        'enterprise-compliance-subtitle': 'Specially developed for companies with high compliance complexity',
        'enterprise-card-1-title': 'Organizational Complexity',
        'enterprise-card-1-desc': 'Multiple locations, hundreds of employees, complex organizational structures',
        'enterprise-card-1-item-1': '250+ Employees',
        'enterprise-card-1-item-2': 'Multiple Locations & Subsidiaries',
        'enterprise-card-1-item-3': 'Decentralized Responsibilities',
        'enterprise-card-2-title': 'Regulatory Requirements',
        'enterprise-card-2-desc': 'Obligation to comply with multiple national and international standards',
        'enterprise-card-2-item-1': 'NIS2, DORA, EU AI Act, CRA, ...',
        'enterprise-card-2-item-2': 'ISO 27001, ISO 9001, TISAX, ...',
        'enterprise-card-2-item-3': 'Industry-specific Regulations',
        'enterprise-card-3-title': 'Regulated Customers',
        'enterprise-card-3-desc': 'Business relationships with customers who require strict compliance verification',
        'enterprise-card-3-item-1': 'Financial Service Providers & Banks',
        'enterprise-card-3-item-2': 'Authorities & Defense',
        'enterprise-card-3-item-3': 'Critical Infrastructure Companies',
        'enterprise-cta-text': 'Do you recognize your company?',
        'eu-flag-text': 'Built & Hosted in the EU',
        ...
        'jobs-no-openings': 'We currently do not have any open positions, but we are always happy to receive unsolicited applications at <a href="mailto:hello@maiqo.io">hello@maiqo.io</a>.',
        ...
        'job-3-title': 'AI/ML Engineer',
        'job-3-description': 'Develop and optimize AI models for compliance automation and document analysis.',
        'job-type-fulltime': 'Full-time',
        'job-tag-remote': 'Remote',
        'job-tag-germany': 'Germany',
        ...
        'footer-made-in-germany': 'Made in Germany',
        'impressum-page-title': 'Legal Notice - maiqo.io',
        ...
        'job-intro-2': '<strong>What makes us special:</strong> Data sovereignty. Operations in Germany, a consistently European approach – ideal for sensitive compliance and security data.',
        'job-intro-3': 'For further expansion, we are looking for a first Full-Stack Developer who is excited to help shape a SaaS product technically from the ground up – architecture, development, AI features, and operations.',
        'job-section-tasks': 'Your Tasks',
        'job-task-1': 'End-to-end development of our SaaS application (Frontend, Backend, Database)',
        'job-task-2': 'Co-design of architecture, data model, and technical standards',
        'job-task-3': 'Implementation of new features in Next.js / TypeScript including clean API design',
        'job-task-4': 'Ensuring quality and stability (Tests, Reviews, Monitoring, reliable Deployments)',
        'job-task-5': 'Shared responsibility for operations and DevOps in a lean, automated setup (CI/CD, Monitoring, Observability)',
        'job-task-6': 'AI-close product development: you integrate and productize LLM-based functions (e.g., analysis, assistance, automation) and think about topics like quality, costs, security, and scalability.',
        'job-section-stack': 'Our Stack',
        'job-stack-note': 'Early Stage: modern, fast, pragmatic – and open to good technical decisions.',
        'job-section-requirements': 'What You Should Bring',
        'job-requirements-must': 'Must-have',
        'job-req-must-1': 'Very good knowledge of TypeScript / Node.js / Next.js',
        'job-req-must-2': 'Solid full-stack and architecture experience in SaaS environment',
        'job-req-must-3': 'PostgreSQL & relational data models',
        'job-req-must-4': 'Ownership mindset',
        'job-requirements-experience': 'Experience with',
        'job-req-exp-1': 'Auth, role & permission systems',
        'job-req-exp-2': 'Multi-tenancy & audit logs',
        'job-req-exp-3': 'CI/CD and production operations',
        'job-requirements-nice': 'Nice-to-have',
        'job-req-nice-1': 'Security, compliance, or regulatory proximity',
        'job-req-nice-2': 'Experience with market launches',
        'job-req-nice-3': 'AI/LLM product integration',
        'job-section-benefits': 'What We Offer',
        'job-benefit-1': '<strong>100% Home Office</strong> (remote-first)',
        'job-benefit-2': '<strong>Startup from the beginning:</strong> lots of creative freedom and direct influence on product & architecture',
        'job-benefit-3': '<strong>High responsibility</strong> and short decision paths',
        'job-benefit-4': '<strong>Growth opportunities:</strong> First developer in a growing team',
        'job-benefit-5': '<strong>Modern dev tools</strong> and a setup designed for clean, scalable development',
