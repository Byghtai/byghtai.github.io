...
const i18n = {
    de: {
        ...
        'hero-title-part1': 'Normen, Standards und Gesetze durch',
        ...
        'features-subtitle': 'Verwalten Sie mühelos mehrere Standards, Vorschriften und Gesetze mit intelligenter KI-Automatisierung',
        'feature-1-title': 'Intelligente Automatisierung',
        'feature-1-desc': 'KI-gesteuerte Workflows reduzieren manuelle Arbeit um bis zu 85% und eliminieren menschliche Fehler bei kritischen Compliance-Prozessen.',
        'feature-2-title': 'Einheitliche Übersicht',
        'feature-2-desc': 'Zentrale Dashboard-Ansicht aller Compliance-Standards - von GDPR über ISO 27001 bis hin zu branchenspezifischen Vorschriften.',
        'feature-3-title': 'Kontinuierliche Überwachung',
        'feature-3-desc': 'Echtzeit-Monitoring und proaktive Benachrichtigungen bei Änderungen in Vorschriften oder internen Richtlinien.',
        'feature-4-title': 'Audit-Ready Reports',
        'feature-4-desc': 'Automatisch generierte, audit-konforme Berichte und Nachweise für alle relevanten Stakeholder und Aufsichtsbehörden.',
        'feature-5-title': 'Enterprise Security',
        'feature-5-desc': 'Bank-grade Sicherheit mit End-zu-End-Verschlüsselung, SOC 2 Type II Zertifizierung und vollständiger Datenhoheit.',
        'feature-6-title': 'Schnelle Integration',
        'feature-6-desc': 'Nahtlose Integration in bestehende Systeme über APIs und vordefinierte Konnektoren für alle gängigen Enterprise-Tools.',
        ...
        'datenschutz-plugins': '7. Plugins und Tools',
        'datenschutz-recaptcha': 'Google reCAPTCHA',
        'datenschutz-recaptcha-text1': 'Wir nutzen "Google reCAPTCHA" (im Folgenden "reCAPTCHA") auf unseren Websites. Anbieter ist die Google Ireland Limited ("Google"), Gordon House, Barrow Street, Dublin 4, Irland.',
        'datenschutz-recaptcha-text2': 'Mit reCAPTCHA soll überprüft werden, ob die Dateneingabe auf unseren Websites (z.B. in einem Kontaktformular) durch einen Menschen oder durch ein automatisiertes Programm erfolgt.',
        'datenschutz-auftragsverarbeitung': '8. Auftragsverarbeitung',
        ...
        'datenschutz-ihre-rechte': '9. Ihre Rechte als betroffene Person',
    ...
    en: {
        ...
        'hero-title-part1': 'Seamlessly manage, implement, and prove compliance through intelligent',
        ...
        'features-subtitle': 'Effortlessly manage multiple standards, regulations and laws with intelligent AI automation',
        'feature-1-title': 'Intelligent Automation',
        'feature-1-desc': 'AI-driven workflows reduce manual work by up to 85% and eliminate human errors in critical compliance processes.',
        'feature-2-title': 'Unified Overview',
        'feature-2-desc': 'Central dashboard view of all compliance standards - from GDPR to ISO 27001 to industry-specific regulations.',
        'feature-3-title': 'Continuous Monitoring',
        'feature-3-desc': 'Real-time monitoring and proactive notifications for changes in regulations or internal policies.',
        'feature-4-title': 'Audit-Ready Reports',
        'feature-4-desc': 'Automatically generated, audit-compliant reports and evidence for all relevant stakeholders and supervisory authorities.',
        'feature-5-title': 'Enterprise Security',
        'feature-5-desc': 'Bank-grade security with end-to-end encryption, SOC 2 Type II certification and complete data sovereignty.',
        'feature-6-title': 'Fast Integration',
        'feature-6-desc': 'Seamless integration into existing systems via APIs and predefined connectors for all common enterprise tools.',
        ...
        'impressum-haftung-inhalte-text1': 'As a service provider, we are responsible for our own content on these pages according to § 7 para. 1 TMG under general laws. However, according to §§ 8 to 10 TMG, we as a service provider are not under the obligation to monitor transmitted or stored third-party information or to investigate circumstances that indicate illegal activity.',
        ...
        'datenschutz-plugins': '7. Plugins and Tools',
        'datenschutz-recaptcha': 'Google reCAPTCHA',
        'datenschutz-recaptcha-text1': 'We use "Google reCAPTCHA" (hereinafter "reCAPTCHA") on our websites. Provider is Google Ireland Limited ("Google"), Gordon House, Barrow Street, Dublin 4, Ireland.',
        'datenschutz-recaptcha-text2': 'With reCAPTCHA it should be checked whether the data input on our websites (e.g. in a contact form) is done by a human or by an automated program.',
        'datenschutz-auftragsverarbeitung': '8. Data Processing',
        ...
        'datenschutz-ihre-rechte': '9. Your Rights as a Data Subject',
