...
const i18n = {
    de: {
        ...
        'feature-1-title': 'Zentralisierung in einer Platform',
        'feature-1-desc': 'Alle regulatorischen Vorgaben zentral managen – ohne Insellösungen oder redundante Workflows.',
        'feature-2-title': 'Intelligentes Mapping',
        'feature-2-desc': 'KI verknüpft Anforderungen automatisch mit verschiedenen Regularien für effiziente Mehrfachnutzung.',
        'feature-3-title': 'Umsetzungsvorschläge durch KI',
        'feature-3-desc': 'Konkrete Handlungsempfehlungen für die Umsetzung regulatorischer Anforderungen – praxisnah und zuverlässig.',
        'feature-4-title': 'Nahtlose Audit-Readiness',
        'feature-4-desc': 'Automatische Erstellung prüfungstauglicher Nachweise und Audit-Texte, die jederzeit reportfähig sind.',
    ...
    en: {
        ...
        'feature-1-title': 'Centralization in One Platform',
        'feature-1-desc': 'Manage all regulatory requirements centrally – without isolated solutions or redundant workflows.',
        'feature-2-title': 'Intelligent Mapping',
        'feature-2-desc': 'AI automatically links requirements with various regulations for efficient multiple use.',
        'feature-3-title': 'AI-Powered Implementation Suggestions',
        'feature-3-desc': 'Concrete action recommendations for implementing regulatory requirements – practical and reliable.',
        'feature-4-title': 'Seamless Audit-Readiness',
        'feature-4-desc': 'Automatic creation of audit-ready evidence and texts that are reportable at any time.',
